...
int main(){
    ...
    // Váriáveis para soma dos atributos
    ...
    // // ##############################################
        ...
        case 6:
            ...
            atributo1_carta1 = pib_percapta1;
            atributo1_carta2 = pib_percapta2;          
            break;
        case 7:
        ...
        case 6:
            ...
            atributo2_carta1 = pib_percapta1;
            atributo2_carta2 = pib_percapta2;
            break;
        case 7:
            printf("Atributo Super Poder:\n");
            printf("Carta 1 - %s: %.f\n", cidade1, super_poder1);
        ...
        if (resultado1 && resultado2) {
            printf("\n");
            printf("Carta 1 - %s tem os 2 atributos escolhidos maiores!\n", cidade1);
        } else if (resultado1 != resultado2) {
            printf("\n");
            printf("Cada carta vence em um atributo!\n");
        } else {
            printf("\n");
            printf("*Carta 2 - %s tem os 2 atributos escolhidos maiores!\n", cidade2);   
        }
    }
        ...
        // Resultado/Lógica final do jogo

        if (soma1 > soma2) {
            printf("### Carta 1 - %s tem a maior soma e é a grande vencedora! ###\n", cidade1);
        } else if (soma1 == soma2) {
            printf("##O jogo empatou!##\n");
        } else {
            printf("### Carta 2 - %s tem a maior soma e é a grande vencedora! ###\n", cidade2);
        }
